...
arm_objects_cflags += $(CLANG_QCOM_CONFIG_PARALLEL_FLAGS)
normal_objects_cflags += $(CLANG_QCOM_CONFIG_PARALLEL_FLAGS)
endif

# Add KRAIT FLAGS
arm_objects_cflags += $(CLANG_QCOM_CONFIG_Ofast_FLAGS) 
normal_objects_cflags += $(CLANG_QCOM_CONFIG_Ofast_FLAGS)
