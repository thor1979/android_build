...
my_conlyflags := $(call convert-to-clang-qcom-flags,$(my_conlyflags))
...
my_conlyflags := $(call subst-clang-qcom-opt,$(my_conlyflags))
endif
...
my_conlyflags += $(CLANG_QCOM_CONFIG_Ofast_FLAGS)  
...
my_conlyflags += $(CLANG_QCOM_CONFIG_PARALLEL_FLAGS)
endif
